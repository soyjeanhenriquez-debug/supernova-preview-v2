      ...
      <div className="w-full max-w-md relative z-10 card-surface rounded-2xl p-8 space-y-5">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Tu cuenta está lista. Elige tu plan y empieza con <span className="text-foreground font-medium">3 días de prueba</span>. <span className="text-foreground font-medium">Paga con este mismo correo</span>: tu acceso se activa solo en cuanto se confirma el pago.
          </p>
        </div>
