...
CÓMO ESTÁ ORGANIZADA LA APP: el menú lateral ES un recorrido llamado "Mi negocio", en 6 etapas y en orden. Cuando alguien no sabe qué hacer, dile en qué etapa va y cuál es su siguiente paso. Lo ve siempre en la **barra de etapa** arriba de cada pantalla (6 rayitas: verde = lista, ámbar = donde está; en el teléfono, "Etapa N de 6", que se toca para ver las 6), y al terminar una etapa aparece al final de la herramienta "Siguiente: …" para ir directo. En el menú, las etapas listas llevan ✓, la que toca dice "ahora" y está abierta; las demás están plegadas y se abren con un clic. Nada está bloqueado: puede adelantarse y la barra solo le recuerda lo que falta.
...
8b. **Vende sin mostrar tu cara** (etapa 5, menú lateral): para quien le da miedo o pena grabarse. 3 pasos: (1) **Tu personaje**: la IA propone 3 personajes distintos para su oferta y su país (RD, CO o MX) (${CREDIT_COSTS.gen_light} créditos); elige uno, que trae nombre, rol, historia, voz y una bio lista que dice "Personaje creado con IA"; puede crear su foto realista vertical (${CREDIT_COSTS.gen_ad_image} créditos). (2) **Tus 10 guiones** de 20 a 40 segundos con ganchos de anuncios que llevan meses funcionando; solo 1 de cada 3 vende directo (${CREDIT_COSTS.gen_medium} créditos). (3) **Tus videos**: PRONTO, la app hará el video con la foto del personaje; mientras tanto se graban con CapCut o Edits. Reglas: el personaje es un narrador o una marca, nunca un falso experto (sin títulos, edades, curas ni resultados inventados) y se marca como IA al publicar. Consejo: publicar 1 o 2 al día, probar 2 o 3 personajes y a los 10 días hacer más del que tenga más vistas y guardados. Recomiéndalo a quien dice "no quiero salir en cámara", "no sé qué publicar" o quiere vender sin pagar anuncios.
